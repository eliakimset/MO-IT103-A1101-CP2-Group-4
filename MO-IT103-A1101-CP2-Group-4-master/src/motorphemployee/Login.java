...
public class Login extends JFrame {
    ...
    private void initComponents() {
        ...
        lblTitle.setFont(new java.awt.Font("Arial", Font.BOLD, 18)); // Adjusted font size for better fit
        lblTitle.setHorizontalAlignment(SwingConstants.CENTER);
        lblTitle.setText("MotorPH Employee Management Payroll System");

        lblWelcome.setFont(new java.awt.Font("Arial", Font.PLAIN, 14)); // Adjusted font size for better fit
